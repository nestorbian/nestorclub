...
<div class="fh5co-loader"></div>
    ...
    <div class="main">
    <h2 class="info">个人信息</h2>
    <div class="each"><span class="sp">用户名:${user.username}</span></div><br />
    <div class="each"><span class="sp">密码:${user.password}</span></div><br />
    <div class="each"><span class="sp">真名:${user.truename}</span></div><br />
    <div class="each"><span class="sp">手机号码:${user.phone}</span></div><br />
    <div class="each"><span class="sp">账户余额:${user.account}</span></div><br />
    <div class="each"><span class="sp">地址:${user.address}</span></div><br />
    </div><br />
