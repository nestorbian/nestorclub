		...
		<div class="main-container-inner">
			...
			<div class="page-content">
				<div class="page-header">
					<h1>
						用户管理 <small> <i class="icon-double-angle-right"></i> 用户
							&amp; 列表 </small> <a href="view/back/adduser.jsp"
												...
												<tr>
													...
													<td>
														<div
															...
															<a class="green" href="user/showbyid.do?id=${user.id}"> <i class="icon-pencil bigger-130"></i> </a>
															<a class="red" href="user/deleteuser.do?id=${user.id}"> <i class="icon-trash bigger-130"></i> </a>
														</div></td>
												</tr>
											</c:forEach>
										</tbody>
