		...
		<div class="main-container-inner">
			<div class="page-content">
				<div class="page-header">
					<h1>
						茶具管理 <small> <i class="icon-double-angle-right"></i> 茶具增加/修改
						</small>
					</h1>
				</div>
				<!-- /.page-header -->
				...
				<div class="row">
					<div class="col-xs-12">
						...
						<form class="form-horizontal" role="form" action="goods/addgoods.do"
							method="post" enctype="multipart/form-data">
							<input type="hidden" name="goodid" value="${null==goods?0:goods.goodid }">

							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right"
									for="form-field-1"> 茶具名称 </label>

								<div class="col-sm-9">
									<input type="text" id="form-field-1" placeholder="请输入茶具名称"
										class="col-xs-10 col-sm-5" name="goodname"
										value="${null==goods?'':goods.goodname }" />
								</div>
							</div>
							...
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right"
									for="form-field-1"> 茶具价格 </label>

								<div class="col-sm-9">
									<input type="text" id="form-field-1" placeholder="请输入茶具价格"
										class="col-xs-10 col-sm-5" name="goodprice"
										value="${null==goods?'':goods.goodprice }" />
								</div>
							</div>
							
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right"
									for="form-field-1"> 茶具库存</label>

								<div class="col-sm-9">
									<input type="text" id="form-field-1" placeholder="请输入茶具库存"
										class="col-xs-10 col-sm-5" name="goodstock"
										value="${null==goods?'':goods.goodstock }" />
								</div>
							</div>
							...
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right"
									for="form-field-1"> 茶具图片 </label>

								<div class="col-sm-9">
									<input type="hidden" id="googpath" name="googpath"
										value="${null==goods?'':goods.googpath}">
									<div class="ace-file-input col-xs-10 col-sm-5">
										<input type="file" name="goodfile" id="id-input-file-2">
									</div>
								</div>
							</div>
							...
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right"
									for="form-field-1"> 茶具描述 </label>

								<div class="col-sm-9">
									<textarea rows="5" cols="60" name="goodinfo"  placeholder="请输入茶具描述">${null==goods?'':goods.goodinfo }</textarea>
								</div>
							</div>
