...
<html lang="en">
	...
	<body class="login-layout">
						...
						<div class="login-container">
							<div class="center">
								<h1>
									...
									<span class="white">登入口</span>
								</h1>
								<h4 class="blue">&copy; 茶道公司</h4>
							</div>
								...
								<div id="login-box" class="login-box visible widget-box no-border">
									<div class="widget-body">
										<div class="widget-main">
											...
											<div class="space-6"></div>
											<form action="admin/login.do" method="post" id="loginForm">
												<fieldset>
											...
											<div class="social-or-login center">
												<span class="bigger-110">其他形式登录</span>
											</div>
	    ...
	    <script type="text/javascript" src="backview/js/jquery.validate.min.js"></script>
	    <script type="text/javascript" src="backview/myjs/common.js"></script>
		<!-- <![endif]-->
...
<![endif]-->
		...
		<script type="text/javascript">
			window.jQuery || document.write("<script src='backview/js/jquery-2.0.3.min.js'>"+"<"+"/script>");
		</script>
